                ...
                <section class="page-section mt-5">
                  <div class="container">
                    <center>
                      ...
                      <form action="create_siswa.php" method="post" name="form1">
                        <table width="50%" border="0">
                          ...
                          <tr>
                            <td>Wali Kelas</td>
                            <td><input type="text" name="wali_kelas"></td>
                          </tr>
                          <tr>
                            <td>ID Guru</td>
                      ...
                      if (isset($_POST['Submit'])) {
                        ...
                        $result = mysqli_query($conn, "INSERT INTO siswa(NIS, nama_siswa, kelas, no_telp, wali_kelas, id_guru) VALUES('$NIS', '$nama_siswa', '$kelas', '$no_telp', '$wali_kelas', '$id_guru') ");

                        // Show message when user added
                        echo "Data berhasil ditambahkan  <a class='btn btn-primary' href='datasiswa.php'>Lihat Data</a>";
                      }
                      ?>
                      <br>
